...
exports.run = function (args) {
  ...
  var ask = prompts([{
    ...
    message: "Mongo URL:",
    validate: function validate(value) {
      return !value.startsWith("mongodb://") ? "Must be valid mongodb url" : true;
    }
  }, {
    type: "text",
    name: "views",
    ...
    prompts({
      ...
      if (next.continue === 1) return error({ message: "Spring.js init canceled :(" });
